...
VALUES(900, '장채현', '901123-2345678', 'jan_ch@kh.or.kr', '01012341234', 
...
-- * 조건절을 설정하지 않고 UPDATE 구문 실생 시 모든 행의 컬럼 값 변경
SELECT * FROM DEPARTMENT2;
...
UPDATE EMPLOYEE2
SET 
SALARY = (SELECT SALARY FROM EMPLOYEE2 WHERE EMP_NAME = '유재식')+1,
...
WHERE EMP_ID IN(SELECT EMP_ID
                ...
                JOIN LOCATION ON(LOCATION_ID = LOCAL_CODE)
                WHERE LOCAL_NAME LIKE 'ASIA%');
-- WHERE EMP_ID IN(200,201,202,203,204,205,206,207,208,209,210,214,215,216,217,219,220,221,900);
