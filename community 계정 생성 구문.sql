...
UPDATE MEMBER SET PROFILE_IMG = '/resources/images/go.jpg'
WHERE MEMBER_NO = 1;
...
INSERT INTO REPLY VALUES(SEQ_RNO.NEXTVAL, '박성현 바보 ㅋㅋ', DEFAULT, DEFAULT, 2, 500);
...
-- 댓글 삭제 UPDATE 테이블명 SET 컬럼명 = 바꿀값 [WHERE 컬럼명 비교연산자 비교값]
UPDATE REPLY
SET REPLY_ST = 'Y'
WHERE REPLY_NO = ?;
